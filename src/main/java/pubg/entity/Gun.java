 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * public int getMuzzle() { return muzzle; }
		 * 
		 * public void setMuzzle(int muzzle) { this.muzzle = muzzle; }
		 * 
		 ...
		 * 
		 * public int getButtstock() { return buttstock; }
		 * 
		 * public void setButtstock(int buttstock) { this.buttstock = buttstock; }
		 * 
		 * public PGData getPgData() { return pgData; }
		 * 
		 * public void setPgData(PGData pgData) { this.pgData = pgData; }
		 * 
